...
class _ReadLifeAreasScreenState extends ConsumerState<ReadLifeAreasScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: _selectedArea == null ? cMainColor : cSecondaryColor,
        foregroundColor: cWhiteColor,
        title: Text(
          _selectedArea == null ? 'Áreas da vida' : _selectedArea!.designation,
            ...
            : [
                ...
                IconButton(
                  ...
                  onPressed: () async {
                    ...
                    _exitSelectionMode();
                    await ref
                        .read(lifeAreasProvider.notifier)
                        .deleteLifeArea(area.id);
                    ref.invalidate(lifeAreasProvider);
                  },
                ),
                IconButton(
